...
export const getTicket = createAsyncThunk('tickets/get', async (tickedId, thunkAPI) => {
    try {
        const token = thunkAPI.getState().auth.user.token;
...
export const closeTicket = createAsyncThunk('tickets/close', async (tickedId, thunkAPI) => {
    try {
        const token = thunkAPI.getState().auth.user.token;
